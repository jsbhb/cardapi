package com.fireCloud.tradCity.test;
...
public class TestRSA {
	...
	public static String sign(String privateKeyStr, byte[] content) {
		...
		try {
			...
			privateKey = (RSAPrivateCrtKey) keyFactory
					.generatePrivate(new PKCS8EncodedKeySpec(Base64Util.decode(privateKeyStr)));
		} catch (Exception e) {
		...
		try {
			...
			sig = Base64Util.encode(signature.sign());// do base64 encoding
		} catch (Exception e) {
